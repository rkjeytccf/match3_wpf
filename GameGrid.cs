...
namespace finalKursach
{
    public class GameGrid
    {
        ...
        public int SetBL(bool three)
        {
            this.three = three; 
            _blue = 29;
            return _blue;
        }
        public int GetBL(ref int blue)
        {
            blue = _blue;
            return blue;
        }
        ...
        private bool ExecuteMatch(Vector2 position, ref IFigure firstFigure)
        {
            ...
            {
                figure.Destroy(_figures, _gridSize);
                if (firstFigure.Type == FigureType.Blue && three)
                {
                    _blue--;
                }
            }
